...
const ModeloSolucaoFunction = () => {
  ...
  // Captura os parâmetros da URL com valores padrão
  ...
  return (
    ...
    <div className="">
      <RedLine/>
      {/* Componente de modelo da solução com props */}
      <ModeloSolucao
       descricao1={definicao}
        descricao2={beneficios}
        descricao3={impacto}
      />
    </div>
      <CartoesVisaoResultadoAcertividade leftTitle={leftTitle} leftContent={leftContent} centerTitle={centerTitle} centerContent={centerContent} rightTitle={rightTitle} rightContent={rightContent}/>
  </>
  );
};
