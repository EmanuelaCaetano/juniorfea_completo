...
export default function SobreJRFEA() {
    return (
        <>
            <div className="bg-corPrimaria text-white drop-shadow-lg py-16 px-4 sm:px-6 md:px-12 lg:px-28 xl:px-40 2xl:px-60 flex flex-col justify-center min-h-screen mt-60">
                ...
                <div className="flex flex-col lg:flex-row justify-between items-center gap-8 sm:gap-10 lg:gap-16 pt-8">
                    {/* Texto */}
                    <div className="lg:w-1/2 text-center lg:text-left space-y-6 font-bold text-sm sm:text-base md:text-lg lg:text-xl drop-shadow-lg">
                    ...
                    {/* Imagem */}
                    <div className="lg:w-1/2 max-w-full flex justify-center">
                        <Image
